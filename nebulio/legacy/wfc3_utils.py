...
dataprefix = "data/WFC3-filters/SystemThroughput"
...
def get_filter(fname, UVIS=1, return_wavelength=False):
    ...
    datapath = '/'.join([dataprefix, datafile])
    datastream = pkg_resources.resource_stream(__name__, datapath) 
    data = np.genfromtxt(datastream, names=("row", "wavelength", "throughput"))
