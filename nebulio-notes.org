...
* [5/8] Project Management Scaffolding
:LOGBOOK:
...
- [ ] sort out relative imports
  - AAARGH!
  - [ ] try to follow recommendations [[http://guide.python-distribute.org/creation.html][here]]
